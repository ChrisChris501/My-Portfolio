    ...
    <div className='h-full mb-20'>
      <div className='text-center p-10'>
        ...
        <div className='text-justify mt-8 font-medium leading-8 text-gray-600 p-6 rounded-lg'>
          ...
          <p className='mt-4'>
            As a versatile software developer, I provide a range of services tailored to the needs of both <span className='text-pink-800'>companies</span>  and <span className='text-pink-800'>individuals</span> . I excel in collaborative team environments and also manage projects independently, delivering high-quality solutions every time.
          </p>
          <p className='mt-4'>
