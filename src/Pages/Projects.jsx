    ...
    <div className='project-card p-6 border-2 rounded-lg border-x-red-800 shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col h-full'>
      ...
      <div className='mt-auto'>
        <div className='flex justify-between'>
          <a href={Site} target="_blank" rel="noopener noreferrer" className='text-grey-300 hover:text-pink-700 transition-colors duration-300 underline'>Visit website</a>
          <a href={GithubLink} target="_blank" rel="noopener noreferrer" className='text-grey-300 hover:text-pink-700 transition-colors duration-300 mr-5 underline'>View GitHub Repository</a>
        </div>
      </div>
    </div>
  );
